...
<div class="container cf">
  ...
  <div class="about">
      <section class="about section">
          ...
          <div class="for-you" >
            <h2><?php $at = new Area('Heading For-you');
$at->display($c);
?></h2>
...
?>
          ...
          <div class="learnings" >
            <h2><?php $at = new Area('Heading Learnings');
$at->display($c);
?></h2>
            <div class="inner margins-vert" >
<?php
...
?>
          ...
          <div class="meet">
          <h2><?php $at = new Area('Heading Meeting');
$at->display($c);
?></h2>
            <div class="inner margins-vert">
<?php
...
<div class="container">
    <section class="organisers section">
       <h2><?php $at = new Area('Heading Organisers');
$at->display($c);
?></h2>
      <div class="inner">
...
?>
      ...
      <h2><?php $at = new Area('Heading This-site');
$at->display($c);
?></h2>
